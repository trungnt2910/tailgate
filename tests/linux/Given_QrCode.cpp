...
TEST(Given_QrCode, When_AutomaticFormatUsesLegacyLocale_Then_AsciiIsSelected)
{
...
TEST(Given_QrCode, When_AutomaticFormatUsesUtf8Locale_Then_CompactUnicodeIsSelected)
{
