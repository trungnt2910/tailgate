...
TEST(Given_State, When_IdentityWithDiscoKeyAndPersisting_Then_AllClientKeysRoundTrip)
{
...
TEST(Given_State, When_PersistedProfileAndRemovingProfile_Then_IdentityBoundStateIsDeleted)
{
...
TEST(Given_State, When_PendingLoginAndPersistingDaemonStatus_Then_AuthorizationUrlRoundTrips)
{
