...
TailnetHost FindHost(const control::NetworkConfig& config, const std::string& queriedName)
{
    struct Node
    {
...
bool IsTailnetName(const control::NetworkConfig& config, const std::string& name)
{
